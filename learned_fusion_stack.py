...
def main():
    ...
    if args.shots and args.shots > 0:
        ...
        # build centroids with up to shots per class
        ...
        clip_train = sims_to_probs(emb_train)
        clip_val = sims_to_probs(emb_val)
        clip_test = sims_to_probs(emb_test)
    else:
